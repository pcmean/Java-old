public class TileGameDriver
   ...
   public static void main( String[] args )
      ...
      System.out.println("Result of calling getIndexForFit with test tile 1: " + myGame.getIndexForFit(testTile1));
      System.out.println("Result of calling getIndexForFit with test tile 2: " + myGame.getIndexForFit(testTile2));
      System.out.println(myGame);
      
      System.out.println("\n\nPart 5: Testing insertTile...");
      System.out.println("Result of calling myGame.insertTile: "+myGame.insertTile());
