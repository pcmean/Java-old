...
public class ticTacToe{
    ...
    public static void main(String[]args){
        ...
        while(end!=true)//main game
            ...
            if((win==true)||(full==true)||(loose==true)){end=true;}
        }
        ...
        for(int y=0; y<3; y++){
            ...
            for(int x=0; x<3; x++){
                ...
                else{System.out.print("["+theBoard[y][x]+"]");}
            }
            System.out.println();
        }
        if(win==true){System.out.println("You Win!");}
        else if(loose==true){System.out.println("Better luck next time.");}
        else if(full==true){System.out.println("Cat's game!");}
    }
}