...
public class CardGameGUI extends JFrame implements ActionListener, Runnable
{
  ...
  private void initDisplay()
  {
    ...
    for (int n = 0; n < this.board.size(); n++)
    {
      ...
      this.displayCards[n].addMouseListener(new CardGameGUI.MyMouseListener());
  ...
  private class MyMouseListener implements MouseListener
  {
   ...
   // CardGameGUI(CardGameGUI paramCardGameGUI) {}
  //CardGameGUI$1(CardGameGUI paramCardGameGUI) {}
